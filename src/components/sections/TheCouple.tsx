...
export default function TheCouple() {
        ...
        { opacity: 0, y: 70, filter: "blur(8px)" },
        {
          ...
          onComplete: () => {
            ...
            gsap.to(".couple-frame", {
              boxShadow:
                "0 0 50px rgba(107,168,122,0.25), 0 8px 40px rgba(0,0,0,0.08)",
              duration: 2.5,
              repeat: -1,
              yoyo: true,
              ease: "sine.inOut",
  ...
  return (
    <section
      ...
      style={{
        background:
          "radial-gradient(ellipse 90% 70% at 50% 55%, #fef9f0 0%, #f5f7ee 45%, #edf4ee 100%)",
      }}
    >
      ...
      <div className="absolute bottom-8 left-8 scale-y-[-1]">
        <LeafCorner />
      </div>
      <div className="absolute bottom-8 right-8 scale-[-1]">
        <LeafCorner />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="couple-heading text-center mb-20">
          <p className="font-sans text-[9px] tracking-[0.6em] text-sage/50 uppercase mb-4">
            The story of two
          </p>
          <h2 className="shimmer-text font-serif text-5xl md:text-7xl mb-5">
            The Couple
          </h2>
          {/* Ornamental divider */}
          <div className="flex items-center justify-center gap-4 mt-2">
            ...
            >
              <path
                d="M10 2 Q14 6 10 10 Q6 14 10 18"
                stroke="currentColor"
                strokeWidth="0.8"
                fill="none"
              />
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-20 max-w-5xl mx-auto">
          ...
          <div className="couple-card flex flex-col items-center text-center w-full md:w-2/5">
            ...
            <div
              className="couple-img-container p-2 bg-gradient-to-b from-gold/30 via-sage/20 to-gold/10 shadow-[0_15px_35px_rgba(0,0,0,0.1)] mb-7 hover:scale-[1.03] transition-all duration-500"
              style={{ borderRadius: "0 0 138px 138px" }}
            >
              <div
                className="couple-frame relative overflow-hidden border border-sage/30 bg-[#050f07]"
                style={{
                  height: "340px",
                  width: "260px",
            ...
            <div className="flex items-center gap-3 mb-1">
              ...
              <h3
                className="font-script text-5xl text-[#1a3020]"
                style={{ lineHeight: 1.4, padding: "0.05em 0.1em" }}
              >
                Shashank
              </h3>
              <div className="w-6 h-[1px] bg-gold/40" />
            </div>
            <p className="font-sans text-sage/60 tracking-[0.4em] uppercase text-[9px] mb-4">
              The Groom
            </p>
            <p className="font-sans text-[#1a3020]/60 leading-relaxed max-w-xs text-sm">
              Kind-hearted and steadfast, Shashank is the anchor and the perfect
              partner for their beautiful journey ahead.
            </p>
          </div>
          ...
          <div className="hidden md:flex flex-col items-center gap-3 shrink-0">
            ...
            <span className="font-serif text-3xl italic text-gold/50">
              &amp;
            </span>
            <div className="w-[1px] h-20 bg-gradient-to-b from-transparent via-sage/25 to-transparent" />
          </div>
          ...
          <div className="couple-card flex flex-col items-center text-center w-full md:w-2/5">
            ...
            <div className="couple-img-container p-2 rounded-t-full bg-gradient-to-b from-gold/30 via-sage/20 to-gold/10 shadow-[0_15px_35px_rgba(0,0,0,0.1)] mb-7 hover:scale-[1.03] transition-all duration-500">
              <div
                className="couple-frame relative w-60 h-76 md:w-72 md:h-88 rounded-t-full overflow-hidden border border-sage/30 bg-[#050f07]"
            ...
            <p className="font-sans text-[#1a3020]/60 leading-relaxed max-w-xs text-sm">
              Radiant and full of life, Harnika brings joy and warmth to every
